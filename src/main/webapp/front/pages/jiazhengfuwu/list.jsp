        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="jiazhengleixing" id="jiazhengleixing" placeholder="家政类型" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">服务费用</label>
              <div class="layui-input-inline">
                <input type="text" name="fuwufeiyong" id="fuwufeiyong" placeholder="服务费用" autocomplete="off" class="layui-input">
              </div>
            </div>   
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../jiazhengfuwu/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.jiazhengtupian?item.jiazhengtupian.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.jiazhengxingming}}</h5>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jiazhengleixing').val()) {
          param['jiazhengleixing'] = jquery('#jiazhengleixing').val() ? '%' + jquery('#jiazhengleixing').val() + '%' : '';
        }  
        if (jquery('#fuwufeiyong').val()) {
          param['fuwufeiyong'] = jquery('#fuwufeiyong').val() ? '%' + jquery('#fuwufeiyong').val() + '%' : '';
        }  
        // 获取列表数据
