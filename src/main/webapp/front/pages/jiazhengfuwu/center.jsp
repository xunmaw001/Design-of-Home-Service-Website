				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="jiazhengleixing" id="jiazhengleixing">
									<option value="">请选择</option>
							...
							<div class="layui-input-block">
								<input type="text" name="gongzuonianshu" id="gongzuonianshu" placeholder="工作年数" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="jiazhengtupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="jiazhengtupian" name="jiazhengtupian" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																																																																																															// 图片赋值
					jquery("#jiazhengtupianImg").attr("src", data.data.jiazhengtupian);
																																		});
