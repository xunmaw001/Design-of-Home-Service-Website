...
<body>
    ...
    <div class="plate">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in jiazhengzixunList" v-bind:key="index">
                <a target="_self" :href="'../jiazhengzixun/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.fengmiantupian?item.fengmiantupian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in jiazhengfuwuList" v-bind:key="index">
                <a target="_self" :href="'../jiazhengfuwu/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.jiazhengtupian?item.jiazhengtupian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`jiazhengzixun/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.jiazhengzixunList = res.data.list;
      });
      http.request(`jiazhengfuwu/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.jiazhengfuwuList = res.data.list;
      });
    });
  </script>
</body>
