		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑家政评价</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>家政评价管理</span></li>
								<li class="breadcrumb-item active"><span>编辑家政评价</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">家政评价信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>预约编号</label>
										<input id="yuyuebianhao" name="yuyuebianhao" class="form-control" placeholder="预约编号">
									</div>
									<div class="form-group col-md-6">
										<label>家政姓名</label>
									...
									<div class="form-group col-md-6">
										<label>满意度</label>
										<select id="manyiduSelect" name="manyidu" class="form-control">
												<option value=""></option>
												<option class="manyiduOption" value="满意">
													满意
												</option>
												<option class="manyiduOption" value="一般">
													一般
												</option>
												<option class="manyiduOption" value="不满意">
													不满意
												</option>
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>评价内容</label>
										<input id="pingjianeirong" name="pingjianeirong" class="form-control" placeholder="评价内容">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiazhengpingjia/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("jiazhengpingjia/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiazhengpingjia/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("jiazhengpingjia"+colName,"GET",{
		...
		function dataBind(){
			...
			var manyiduOptions = document.getElementsByClassName("manyiduOption");
			for(var manyiduCount = 0; manyiduCount < manyiduOptions.length;manyiduCount++){
				if(manyiduOptions[manyiduCount].getAttribute('value') == ruleForm.manyidu){
					manyiduOptions[manyiduCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.manyidu != null && res.data.manyidu != ''){

					var manyiduOptions = document.getElementsByClassName("manyiduOption");
						for(var manyiduCount = 0; manyiduCount < manyiduOptions.length;manyiduCount++){
							if(manyiduOptions[manyiduCount].getAttribute('value') == res.data.manyidu){
								manyiduOptions[manyiduCount].setAttribute('selected','selected');
							}
						}
					}
