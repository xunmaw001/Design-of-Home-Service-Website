...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "家政评价"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"jiazhengpingjia\")");
			if(crossBtnControl('家政评价') == true){
		...
		function sh(){
			...
			httpJson("jiazhengyuyue/update","POST",data,(res)=>{
				if(res.code == 0){
