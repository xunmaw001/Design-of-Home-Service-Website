						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jiazhengleixing" name="jiazhengleixing" class="form-control" v-model="ruleForm.jiazhengleixing" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>服务费用</label>

									<input id="fuwufeiyong" name="fuwufeiyong" class="form-control" v-model="ruleForm.fuwufeiyong" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>联系方式</label>
									...
									<input id="gongzuonianshu" name="gongzuonianshu" class="form-control" v-model="ruleForm.gongzuonianshu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>家政图片</label>

									<img id="jiazhengtupianImg" src="" width="100" height="100">
									</div>
									<div class="form-group col-md-6">
									<label>个人简介</label>

									<input id="gerenjianjie" name="gerenjianjie" class="form-control" v-model="ruleForm.gerenjianjie" readonly>
									</div>
